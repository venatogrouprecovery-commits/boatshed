...
export const brandLogos: BrandLogo[] = [
  { name: 'Fairline', category: 'Boat builders', domain: 'fairline.com', logo_url: '/brand-logos/fairline.png' },
  { name: 'Princess', category: 'Boat builders', domain: 'princessyachts.com', logo_url: '/brand-logos/princess.png' },
  { name: 'Sunseeker', category: 'Boat builders', domain: 'sunseeker.com', logo_url: '/brand-logos/sunseeker.png' },
  { name: 'Beneteau', category: 'Boat builders', domain: 'beneteau.com', logo_url: '/brand-logos/beneteau.png' },
  { name: 'Jeanneau', category: 'Boat builders', domain: 'jeanneau.com', logo_url: '/brand-logos/jeanneau.png' },
  { name: 'Bavaria', category: 'Boat builders', domain: 'bavariayachts.com', logo_url: '/brand-logos/bavaria.png' },
  { name: 'Sealine', category: 'Boat builders', domain: 'sealine.com', logo_url: '/brand-logos/sealine.png' },
  { name: 'Ribeye', category: 'RIBs', domain: 'ribeye.co.uk', logo_url: '/brand-logos/ribeye.png' },
  { name: 'Volvo Penta', category: 'Engines', domain: 'volvopenta.com', logo_url: '/brand-logos/volvo-penta.png' },
  { name: 'Mercury', category: 'Outboards', domain: 'mercurymarine.com', logo_url: '/brand-logos/mercury.png' },
  { name: 'Yamaha', category: 'Outboards', domain: 'yamaha-motor.eu', logo_url: '/brand-logos/yamaha.png' },
  { name: 'Suzuki', category: 'Outboards', domain: 'suzuki-marine.co.uk', logo_url: '/brand-logos/suzuki.png' },
  { name: 'Garmin', category: 'Electronics', domain: 'garmin.com', logo_url: '/brand-logos/garmin.png' },
  { name: 'Raymarine', category: 'Electronics', domain: 'raymarine.com', logo_url: '/brand-logos/raymarine.png' },
  { name: 'Victron', category: 'Power systems', domain: 'victronenergy.com', logo_url: '/brand-logos/victron.png' },
  { name: 'Lewmar', category: 'Deck hardware', domain: 'lewmar.com', logo_url: '/brand-logos/lewmar.png' },
  { name: 'Force 4', category: 'Chandlery', domain: 'force4.co.uk', logo_url: '/brand-logos/force4.png' },
  { name: 'Spinlock', category: 'Safety gear', domain: 'spinlock.co.uk', logo_url: '/brand-logos/spinlock.png' },
  { name: 'Crewsaver', category: 'Life jackets', domain: 'crewsaver.com', logo_url: '/brand-logos/crewsaver.png' },
  { name: 'Plastimo', category: 'Safety & chandlery', domain: 'plastimo.com', logo_url: '/brand-logos/plastimo.png' },
  { name: 'Gill', category: 'Marine clothing', domain: 'gillmarine.com', logo_url: '/brand-logos/gill.png' },
  { name: 'Musto', category: 'Marine clothing', domain: 'musto.com', logo_url: '/brand-logos/musto.png' },
  { name: 'Helly Hansen', category: 'Marine clothing', domain: 'hellyhansen.com', logo_url: '/brand-logos/helly-hansen.png' },
  { name: 'Navionics', category: 'Navigation', domain: 'navionics.com', logo_url: '/brand-logos/navionics.png' }
];
